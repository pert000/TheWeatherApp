    ...
    override fun onCreateView(
        ...
        binding.detailsBTN.setOnClickListener {
            ...
            findNavController().navigate(
                R.id.action_navigation_place_one_to_detailsFragment,
                bundleOf(DetailsFragment.lon to tbilisi.longitude.toString(), DetailsFragment.lat to tbilisi.latitude.toString() )
